...
<x-guest-layout>
    <form method="POST" action="{{ route('koleksi.storeKoleksi') }}">
        ...
        <div class="mt-4">
            ...
            <div>
                <label for="jenisKoleksi_1" class="text-white">Buku</label>
                <input id="jenisKoleksi_1" type="radio" name="jenisKoleksi" required value="1" />
            </div>
            <div>
                <label for="jenisKoleksi_2" class="text-white">Majalah</label>
                <input id="jenisKoleksi_2" type="radio" name="jenisKoleksi" required value="2" />
            </div>
            <div>
                <label for="jenisKoleksi_3" class="text-white">Cakram Digital</label>
                <input id="jenisKoleksi_3" type="radio" name="jenisKoleksi" required value="3" />
            </div>
